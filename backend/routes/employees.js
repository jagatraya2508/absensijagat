...
router.put('/:id', authenticateToken, isAdmin, async (req, res) => {
    try {
        ...
        `, [
            ...
            is_driver || false, is_collector || false, use_tracking || false, driver_subuh_allowance || 0, driver_rit_allowance || 0, driver_inap_allowance || 0, driver_ritase_allowance || 0,
