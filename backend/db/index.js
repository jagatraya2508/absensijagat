...
pool.query('ALTER TABLE employee_details ADD COLUMN IF NOT EXISTS receives_tuang BOOLEAN DEFAULT TRUE')
  .catch((err) => console.warn('DB patch receives_tuang:', err.message));
